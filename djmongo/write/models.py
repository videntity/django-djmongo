...
class WriteAPIHTTPAuth(models.Model):
    ...
    groups          = models.ManyToManyField(Group,  blank=True,
                                ...
                                help_text = _("Use ctrl to select multiple groups. If no groups are selected blank, any user may access the API."))
    slug            = models.SlugField(max_length=100, unique=True,
                            help_text=_("The slug is the unique part of the URL for your API."))
...
class WriteAPIIP(models.Model):
    ...
    from_ip          = models.TextField(max_length=2048, default="127.0.0.1",           
                            ...
                            help_text=_("Only accept requests from a IP in this list (separated by whitespace). 0.0.0.0 means all."))
    creation_date   = models.DateField(auto_now_add=True)
